...
<div id="kt_app_header" class="app-header" data-kt-sticky="true" data-kt-sticky-activate="{default: true, lg: true}" data-kt-sticky-name="app-header-minimize" data-kt-sticky-offset="{default: '200px', lg: '0'}" data-kt-sticky-animation="false">
    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="{{ route('client.dashboard') }}" class="d-lg-none" wire:navigate>
            ...
            <div class="app-navbar flex-shrink-0">
                        ...
                        <div data-kt-search-element="content" class="menu menu-sub menu-sub-dropdown p-7 w-325px w-md-375px">
                            <div data-kt-search-element="wrapper">
                                <form data-kt-search-element="form" class="w-100 position-relative mb-3" autocomplete="off">
                                    ...
                                    <input type="text" class="search-input form-control form-control-flush ps-10" name="search" value="" placeholder="Tìm dịch vụ..." />
                                </form>
                                <div class="separator border-gray-200 mb-6"></div>
                                <div class="text-center py-5">Nhập từ khóa tìm kiếm...</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="app-navbar-item ms-1 ms-md-4">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px" data-kt-menu="true">
                        ...
                        <div class="scroll-y mh-325px my-5 px-8 text-center py-10">Không có thông báo mới</div>
                    </div>
                </div>
                <!--end::Notifications-->
