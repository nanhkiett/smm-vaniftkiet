        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper">
            <div id="kt_app_sidebar_menu_scroll" class="scroll-y my-5 mx-3" data-kt-scroll="true"
                ...
                <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_app_sidebar_menu"
                    ...
                    @if (auth()->check() && auth()->user()->role === 'admin')
                        <div class="menu-item pt-5">
                            <div class="menu-content">
                                <span
                                    class="menu-heading fw-bolder text-uppercase fs-7 text-primary">Trang quản trị</span>
                            </div>
                        </div>
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{ Route::is('admin.dashboard') ? 'active' : '' }}"
                                ...
                                <span class="menu-title fw-semibold text-gray-200">Bảng điều khiển</span>
                            </a>
                        </div>
                    @endif
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ Route::is('client.dashboard') ? 'active' : '' }}"
                            href="{{ route('client.dashboard') }}" wire:navigate>
                            <span class="menu-icon">
                                <i class="ki-duotone ki-handcart fs-2"><span class="path1"></span><span
                                        class="path2"></span></i>
                            </span>
                            <span class="menu-title">Khởi tạo đơn hàng</span>
                        </a>
                    </div>

                    <div class="menu-item">
                        <a class="menu-link {{ Route::is('client.profile') ? 'active' : '' }}"
                            href="{{ route('client.profile') }}" wire:navigate>
                            <span class="menu-icon">
