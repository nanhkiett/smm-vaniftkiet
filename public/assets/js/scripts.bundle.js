...
var KTLayoutSearch = function() {
	...
	return {
		init: function() {
            ...
            // Guard: Bỏ qua init nếu element không tồn tại hoặc không có đúng thuộc tính Metronic Search
            if (!element || !element.hasAttribute('data-kt-search-keypress')) {
                return;
            }
            ...
            // Guard: chỉ bind events nếu searchObject có method .on() (tương thích SPA/Livewire)
            if (searchObject && typeof searchObject.on === 'function') {
                // Demo search handler
